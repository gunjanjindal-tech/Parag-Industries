...
export default function ContactClient() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#051923] via-[#0d3b66] to-[#051923] pt-12 pb-12 sm:pt-14 sm:pb-14 md:pt-16 md:pb-16">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-14">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="mt-5 text-gray-300 max-w-xl mx-auto text-base sm:text-lg">
              Talk to our experts for industrial fencing solutions tailored to your needs.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 items-stretch">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <a
                href="https://maps.google.com/maps?q=Parag+Industries,+RIICO+Industrial+Area,+Jaipur"
                target="_blank"
          ...
          >
            ...
            <form ref={formRef} onSubmit={sendEmail} className="space-y-4 flex flex-col">
              ...
              <input
                ...
                required
                className="w-full px-4 py-2.5 rounded-lg bg-white/10 border border-white/20 text-white placeholder:text-gray-400"
              />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-yellow-400 text-black py-2.5 rounded-xl font-semibold hover:scale-105 transition shadow-lg cursor-pointer hover:bg-yellow-300 disabled:opacity-60 disabled:cursor-not-allowed"
              >
